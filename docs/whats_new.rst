...
- Parameter names `trial_start_offset_samples` and `trial_stop_offset_samples` of :func:`create_windows_from_events` and related functions changed to `start_offset_samples` and `stop_offset_samples` (:gh:`246`)
